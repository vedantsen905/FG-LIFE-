      ...
      <section className="bg-gradient-to-b from-blue-50 to-white px-6 py-24 md:px-12 lg:px-24">
        ...
        >
          ...
          <p className="text-xl text-gray-600">
            Financial security when facing critical illnesses
          </p>
        </motion.div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                Trauma insurance, also known as critical illness insurance, provides a lump sum payment if you're diagnosed with a specified critical illness like cancer, heart attack, stroke, or major organ failure.
              </p>
              <p>
                The payment can help cover medical expenses, rehabilitation costs, or provide financial support if you're unable to work during recovery.
              </p>
            </div>
          </motion.div>
          ...
          >
            <Image
              src="/images/trauma-insurance.png"
              alt="Trauma Insurance Illustration"
              fill
      ...
      <section className="bg-gray-50 px-6 py-16 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                By having trauma cover, you can reduce the financial stress that often accompanies serious illness, allowing you to focus on recovery.
              </p>
              <p>
                Trauma insurance is typically sold as a standalone policy or as an add-on to life insurance. Carefully review policy terms to understand coverage.
              </p>
              <p>
                Consult a financial adviser to ensure the policy fits your overall financial plan.
              </p>
            </div>
          </motion.div>
          ...
          >
            <Image
              src="/images/trauma-why.png"
              alt="Why Trauma Insurance Matters"
              fill
              className="object-cover"
            />
          </motion.div>
      ...
      <section className="px-6 py-16 md:px-12 lg:px-24 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">
            Key Benefits of Insurance Protection
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              >
                <h3 className="text-xl font-semibold mb-3">Need Trauma Coverage?</h3>
